...
SphereStarDecompCalculator::~SphereStarDecompCalculator()
{
}
...
std::pair< EmbeddedGraph *, EmbeddedGraph * > SphereStarDecompCalculator::decomposition()
{
	...
	{
		Data::AutoArray<bool> mark(graph.numberOfFaces(), false);
...
bool SphereStarDecompCalculator::testFaceSet(bool mark[], size_t faces)
{
	...
	Data::DisjointSets comps(graph.numberOfVertexes());
