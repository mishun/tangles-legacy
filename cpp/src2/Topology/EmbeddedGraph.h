...
namespace Topology
{
	...
	//        *               |     f0 (1)           \  e0 (1)  /
	//      v0 (0)          e0 (0)             v0 (0) *--------* v1 (2)
	class EmbeddedGraph : public Util::IDestroyable, public Util::UniqueObject
	{
	public:
		class Vertex;
		class Face;
	...
	public:
		...
		static EmbeddedGraph & createRandom(Util::IRandom &, size_t, size_t);
	};
	...
	class EmbeddedGraph::Vertex : public Util::UniqueObject
	{
	public:
	...
	class EmbeddedGraph::Face : public Util::UniqueObject
	{
	public:
		virtual size_t idInGraph() const = 0;
		virtual size_t numberOfIncidentEdges() const = 0;
	...
	class EmbeddedGraph::Edge : public Util::UniqueObject
	{
	public:
		virtual size_t idInGraph() const = 0;
		virtual const ConnectionToVertex incidentVertex(size_t) const = 0;
